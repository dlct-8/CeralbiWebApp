...
<html>
  ...
  <!-- Icon -->
	...
	<!-- Google Fonts -->
	  <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,400i,500,500i,600,600i,700,700i" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Roboto:400,400i,500,500i,600,600i,700,700i" rel="stylesheet">
  ...
  <!-- Footer section -->
    <div class="footer-top">
            ...
            <tr >
               ...
               <td class="col-md-3 ">
    			...
    			<ul class="list-unstyled nav-links">
    				...
    				<li><a href="AdminPanel.jsp">Administrador</a></li>
        ...
        <td  class="col-md-4  text-md-center" >
          <p class=""><a href="Contact.jsp" class="btn btn-footer">Contáctanos</a></p>
